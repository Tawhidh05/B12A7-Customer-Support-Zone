    ...
    <>
      {tickets.map((ticket) => {
        ...
        return (
          <div
            key={ticket.id}
            className={`${isInProgress || isCompleted ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'}`}
              ...
              <div className="card-body">
                <div className='flex justify-between'>
                  ...
                  {isCompleted ? (
                    ...
                    <button
                      disabled
                      className='bg-[#1a1a1a] text-white p-1 pr-2 pl-2 rounded-2xl cursor-not-allowed'
                    >
                    ...
                    <button
                      disabled
                      className='bg-[#F8F3B9] text-[#9C7700] p-1 pr-2 pl-2 rounded-2xl cursor-not-allowed'
                    >
