    ...
    return (
        <div className=''>
            ...
            <div className="card-body">
                ...
                {/* Open Status */}
                <button className='bg-[#B9F8CF] text-[#0B5E06] p-1 pr-2 pl-2 rounded-2xl'><FontAwesomeIcon className='text-[#02A53B]' icon={faCircle} />Open</button>
               {/* In-progress */}
                {/* <button className='bg-[#F8F3B9] text-[#9C7700] p-1 pr-2 pl-2 rounded-2xl'><FontAwesomeIcon className='text-[#FEBB0C] ' icon={faCircle} />In-progress</button> */}
                ...
                {/* Medium Priority */}
                {/* <h5 className='text-[#FEBB0C]'>MEDIUM PRIORITY</h5> */}
                {/* Low Priority */}
                {/* <h5 className='text-[#02A53B]'>LOW PRIORITY</h5> */}
                </div>
