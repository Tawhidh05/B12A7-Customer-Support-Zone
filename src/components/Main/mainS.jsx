...
const mainS = ({ticketsData}) => {
    // const ticketData = Use(ticketsData);
    return ( 
        <div className="main max-w-full flex flex-col lg:flex-row">
            ...
            <div className="mainSection max-w-5xl p-6 md:p-12">
                ...
                <section className='ticker grid grid-cols-1 lg:grid-cols-2 gap-4'>
                    <TC tickets={ticketsData}/>
                </section>
            </div>
            {/* Right side */}
            <section  className="pb-[80px] max-w-2xl overflow-y-auto mx-auto md:mx-auto lg:mx-0">
